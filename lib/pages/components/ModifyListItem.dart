...
class ModifyListItem extends StatefulWidget {
  ...
  late int parentID;
  late _ModifyListItemState? parent;
...
class _ModifyListItemState extends State<ModifyListItem> {
  ...
  void createElement() {
    ...
    ModifyListItem child = ModifyListItem(id: -1, parent: this,key: newkey,);
    setState(() {
...
class TitleRow extends StatelessWidget {
  ...
  final ModifyListItem widget;
  final _ModifyListItemState parentState;
